...
MODULE MoorDyn_Types
    ...
    ! =========  MD_InitInputType  =======
      TYPE, PUBLIC :: MD_InitInputType
        ...
        REAL(ReKi) , DIMENSION(1:20,1:6)  :: PtfmInit      ! initial position of platform [-]
    ...
    ENDIF
     ...
     ! buffers to store meshes, if any
      ...
      Int_Xferred  = 1
        ...
        i2_l = LBOUND(OutData%PtfmInit,2)
        i2_u = UBOUND(OutData%PtfmInit,2)
        ...
        END IF
        mask2 = .TRUE. 
          OutData%PtfmInit = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%PtfmInit))-1 ), mask2, 0.0_ReKi )
      ...
      Int_Xferred = 1
          ...
          Int_Xferred   = Int_Xferred   + 1
            DO I = 1, LEN(InData%name)
              ...
              Int_Xferred = Int_Xferred   + 1
            END DO ! I
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%d
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%w
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%EA
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%BA
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%Can
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%Cat
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%Cdn
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%Cdt
          Db_Xferred   = Db_Xferred   + 1
    ...
    ENDIF
     ...
     ! buffers to store subtypes, if any
      ...
      END IF
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conX
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conY
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conZ
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conM
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conV
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conFX
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conFY
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conFZ
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conCa
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%conCdA
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Ftot))-1 ) = PACK(InData%Ftot,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Ftot)
          DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Mtot))-1 ) = PACK(InData%Mtot,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Mtot)
          DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%S))-1 ) = PACK(InData%S,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%S)
          DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%r))-1 ) = PACK(InData%r,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%r)
          DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%rd))-1 ) = PACK(InData%rd,.TRUE.)
     ...
     ! buffers to store meshes, if any
      ...
      END IF
        ...
        END IF
        mask1 = .TRUE. 
          OutData%Ftot = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Ftot))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Ftot)
        DEALLOCATE(mask1)
        ...
        END IF
        mask2 = .TRUE. 
          OutData%Mtot = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Mtot))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Mtot)
        DEALLOCATE(mask2)
        ...
        END IF
        mask2 = .TRUE. 
          OutData%S = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%S))-1 ), mask2, 0.0_DbKi )
        ...
        END IF
        mask1 = .TRUE. 
          OutData%r = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%r))-1 ), mask1, 0.0_DbKi )
        ...
        END IF
        mask1 = .TRUE. 
          OutData%rd = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%rd))-1 ), mask1, 0.0_DbKi )
    ...
    ENDIF
     ...
     ! buffers to store subtypes, if any
      ...
      Int_Xferred = 1
          ...
          IntKiBuf ( Int_Xferred:Int_Xferred+(1)-1 ) = InData%CtrlChan
          Int_Xferred   = Int_Xferred   + 1
          ...
          Int_Xferred   = Int_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%UnstrLen
          Db_Xferred   = Db_Xferred   + 1
          DbKiBuf ( Db_Xferred:Db_Xferred+(1)-1 ) = InData%BA
          Db_Xferred   = Db_Xferred   + 1
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%r)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%r))-1 ) = PACK(InData%r,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%r)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%rd)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%rd))-1 ) = PACK(InData%rd,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%rd)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%l)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%l))-1 ) = PACK(InData%l,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%l)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%ld)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%ld))-1 ) = PACK(InData%ld,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%ld)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%lstr)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%lstr))-1 ) = PACK(InData%lstr,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%lstr)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%lstrd)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%lstrd))-1 ) = PACK(InData%lstrd,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%lstrd)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%T)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%T))-1 ) = PACK(InData%T,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%T)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%Td)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Td))-1 ) = PACK(InData%Td,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Td)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%Dp)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Dp))-1 ) = PACK(InData%Dp,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Dp)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%Dq)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Dq))-1 ) = PACK(InData%Dq,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Dq)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%Ap)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Ap))-1 ) = PACK(InData%Ap,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Ap)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%Aq)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%Aq))-1 ) = PACK(InData%Aq,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%Aq)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%F)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%F))-1 ) = PACK(InData%F,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%F)
      END IF
     ...
     ! buffers to store meshes, if any
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%r)>0) OutData%r = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%r))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%r)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%rd)>0) OutData%rd = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%rd))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%rd)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%q)>0) OutData%q = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%q))-1 ), mask2, 0.0_DbKi )
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%l)>0) OutData%l = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%l))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%l)
        DEALLOCATE(mask1)
      END IF
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%ld)>0) OutData%ld = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%ld))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%ld)
        DEALLOCATE(mask1)
      END IF
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%lstr)>0) OutData%lstr = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%lstr))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%lstr)
        DEALLOCATE(mask1)
      END IF
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%lstrd)>0) OutData%lstrd = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%lstrd))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%lstrd)
        DEALLOCATE(mask1)
      END IF
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%V)>0) OutData%V = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%V))-1 ), mask1, 0.0_DbKi )
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%T)>0) OutData%T = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%T))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%T)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%Td)>0) OutData%Td = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Td))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Td)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%W)>0) OutData%W = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%W))-1 ), mask2, 0.0_DbKi )
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%Dp)>0) OutData%Dp = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Dp))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Dp)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%Dq)>0) OutData%Dq = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Dq))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Dq)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%Ap)>0) OutData%Ap = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Ap))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Ap)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%Aq)>0) OutData%Aq = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%Aq))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%Aq)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask2 = .TRUE. 
          IF (SIZE(OutData%F)>0) OutData%F = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%F))-1 ), mask2, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%F)
        DEALLOCATE(mask2)
      END IF
      ...
      ELSE
        ...
        END IF
        mask3 = .TRUE. 
          IF (SIZE(OutData%S)>0) OutData%S = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%S))-1 ), mask3, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%S)
        DEALLOCATE(mask3)
      END IF
      ...
      ELSE
        ...
        END IF
        mask3 = .TRUE. 
          IF (SIZE(OutData%M)>0) OutData%M = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%M))-1 ), mask3, 0.0_DbKi )
    ...
    ENDIF
     ...
     ! buffers to store subtypes, if any
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%states)>0) DbKiBuf ( Db_Xferred:Db_Xferred+(SIZE(InData%states))-1 ) = PACK(InData%states,.TRUE.)
          Db_Xferred   = Db_Xferred   + SIZE(InData%states)
      END IF
     ...
     ! buffers to store meshes, if any
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%states)>0) OutData%states = UNPACK(DbKiBuf( Db_Xferred:Db_Xferred+(SIZE(OutData%states))-1 ), mask1, 0.0_DbKi )
          Db_Xferred   = Db_Xferred   + SIZE(OutData%states)
        DEALLOCATE(mask1)
      END IF
    ...
    ENDIF
     ...
     ! buffers to store subtypes, if any
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%DeltaL)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%DeltaL))-1 ) = PACK(InData%DeltaL,.TRUE.)
          Re_Xferred   = Re_Xferred   + SIZE(InData%DeltaL)
      END IF
      ...
      ELSE
        ...
        Int_Xferred = Int_Xferred + 2
          ...
          IF (SIZE(InData%DeltaLdot)>0) ReKiBuf ( Re_Xferred:Re_Xferred+(SIZE(InData%DeltaLdot))-1 ) = PACK(InData%DeltaLdot,.TRUE.)
          Re_Xferred   = Re_Xferred   + SIZE(InData%DeltaLdot)
      END IF
     ...
     ! buffers to store meshes, if any
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%DeltaL)>0) OutData%DeltaL = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%DeltaL))-1 ), mask1, 0.0_ReKi )
          Re_Xferred   = Re_Xferred   + SIZE(OutData%DeltaL)
        DEALLOCATE(mask1)
      END IF
      ...
      ELSE
        ...
        END IF
        mask1 = .TRUE. 
          IF (SIZE(OutData%DeltaLdot)>0) OutData%DeltaLdot = UNPACK(ReKiBuf( Re_Xferred:Re_Xferred+(SIZE(OutData%DeltaLdot))-1 ), mask1, 0.0_ReKi )
          Re_Xferred   = Re_Xferred   + SIZE(OutData%DeltaLdot)
        DEALLOCATE(mask1)
      END IF
    ...
    IF (ALLOCATED(u_out%DeltaL) .AND. ALLOCATED(u1%DeltaL)) THEN
      ALLOCATE(b1(SIZE(u_out%DeltaL,1)))
      ALLOCATE(c1(SIZE(u_out%DeltaL,1)))
      b1 = -(u1%DeltaL - u2%DeltaL)/t(2)
      u_out%DeltaL = u1%DeltaL + b1 * t_out
      DEALLOCATE(b1)
      DEALLOCATE(c1)
    END IF ! check if allocated
    IF (ALLOCATED(u_out%DeltaLdot) .AND. ALLOCATED(u1%DeltaLdot)) THEN
      ALLOCATE(b1(SIZE(u_out%DeltaLdot,1)))
      ALLOCATE(c1(SIZE(u_out%DeltaLdot,1)))
      b1 = -(u1%DeltaLdot - u2%DeltaLdot)/t(2)
      u_out%DeltaLdot = u1%DeltaLdot + b1 * t_out
      DEALLOCATE(b1)
      DEALLOCATE(c1)
    END IF ! check if allocated
    ...
    IF (ALLOCATED(u_out%DeltaL) .AND. ALLOCATED(u1%DeltaL)) THEN
      ALLOCATE(b1(SIZE(u_out%DeltaL,1)))
      ALLOCATE(c1(SIZE(u_out%DeltaL,1)))
      b1 = (t(3)**2*(u1%DeltaL - u2%DeltaL) + t(2)**2*(-u1%DeltaL + u3%DeltaL))/(t(2)*t(3)*(t(2) - t(3)))
      c1 = ( (t(2)-t(3))*u1%DeltaL + t(3)*u2%DeltaL - t(2)*u3%DeltaL ) / (t(2)*t(3)*(t(2) - t(3)))
      u_out%DeltaL = u1%DeltaL + b1 * t_out + c1 * t_out**2
      DEALLOCATE(b1)
      DEALLOCATE(c1)
    END IF ! check if allocated
    IF (ALLOCATED(u_out%DeltaLdot) .AND. ALLOCATED(u1%DeltaLdot)) THEN
      ALLOCATE(b1(SIZE(u_out%DeltaLdot,1)))
      ALLOCATE(c1(SIZE(u_out%DeltaLdot,1)))
      b1 = (t(3)**2*(u1%DeltaLdot - u2%DeltaLdot) + t(2)**2*(-u1%DeltaLdot + u3%DeltaLdot))/(t(2)*t(3)*(t(2) - t(3)))
      c1 = ( (t(2)-t(3))*u1%DeltaLdot + t(3)*u2%DeltaLdot - t(2)*u3%DeltaLdot ) / (t(2)*t(3)*(t(2) - t(3)))
      u_out%DeltaLdot = u1%DeltaLdot + b1 * t_out + c1 * t_out**2
      DEALLOCATE(b1)
      DEALLOCATE(c1)
    END IF ! check if allocated
