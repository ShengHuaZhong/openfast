...
MODULE Morison_Types
  ...
  ! =========  Morison_JointType  =======
    TYPE, PUBLIC :: Morison_JointType
      ...
      INTEGER(IntKi) , DIMENSION(1:20)  :: ConnectionList      !< List of Members connected to this joint.  The member index is what is stored, not the Member ID [-]
  ...
  ! =========  Morison_NodeType  =======
    TYPE, PUBLIC :: Morison_NodeType
      ...
      INTEGER(IntKi) , DIMENSION(1:20)  :: ConnectionList      !< Indices of all the members connected to this node (positive if end 1, negative if end 2) [-]
