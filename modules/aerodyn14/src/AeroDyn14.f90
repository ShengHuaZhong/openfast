...
!      CurrentOutputs = ADCurrentLoads
   ...
   m%Rotor%YawAng = ATAN2( -1._ReKi*u%TurbineComponents%RotorFurl%Orientation(1,2), u%TurbineComponents%RotorFurl%Orientation(1,1) )
  ...
  m%Rotor%YawVel =   ( AvgVelNacelleRotorFurlYaw * rRotorFurlHub(2) + AvgVelTowerBaseNacelleYaw * rNacelleHub(2) &
   ...
   DO IBlade = 1,p%NumBl
      ...
      AzimuthAngle = ATAN2( -1._ReKi*DOT_PRODUCT( u%TurbineComponents%Hub%Orientation(3,:),         &
